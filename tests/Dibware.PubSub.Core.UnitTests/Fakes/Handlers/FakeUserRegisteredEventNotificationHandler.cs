...
/// <summary>
/// Represents a fake notification handler for the UserRegisteredEvent used in unit tests.
/// Once the Handle method is called, the HandleCalled property will be set to true.
/// </summary>
public class FakeUserRegisteredEventNotificationHandler : INotificationHandler<UserRegisteredEvent>
{
    /// <summary>
